...
<h3>cdekvelocity</h3>
    <div class="px-5 py-5">
        <ol>
            ...
            <li>В АМО зайти в <a href="https://srogozhnikov.amocrm.ru/amo-market" target="_blank">АМО-маркет</a>.</li>
    ...
    <form method="post" action="{!! route('admin.amo.auth_save_velocity') !!}">
        {{ csrf_field() }}
