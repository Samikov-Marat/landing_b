    ...
    <div class="content">
        <div class="it-solutions__content">
            <div class="it-solutions__left-item">
                ...
                <a href="#" class="primary-button primary-button_with_arrow i18n-h it-solutions__primary-button_desktop">@d('it_solutions_button')</a>
            </div>
            ...
            <a href="#" class="primary-button primary-button_with_arrow i18n-h it-solutions__primary-button_mobile">@d('it_solutions_button')</a>
