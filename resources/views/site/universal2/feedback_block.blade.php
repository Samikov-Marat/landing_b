                    ...
                    <div class="form-field">
                        ...
                        <div class="form-order-customer-type-wrapper">
                            <div class="choice-widget">
                                <input type="radio" name="customer_type" value="legal_entity" id="id_feedback_legal_entity" class="js-form-order-customer-type"><label for="id_feedback_legal_entity">@d('order_form_field_customer_type_legal_entity')</label>
                            </div>
                        </div>
                        <div class="form-order-customer-type-wrapper">
                            <div class="choice-widget">
                                <input type="radio" name="customer_type" value="private_individual" id="id_feedback_private_individual" class="js-form-order-customer-type"><label for="id_feedback_private_individual">@d('order_form_field_customer_type_private_individual')</label>
                            </div>
                        </div>
