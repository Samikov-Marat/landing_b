                ...
                <div class="faq__content">
                    ...
                    <div class="faq-list faq__faq-list">
                        ...
                        <div class="faq-list__faq">
                            ...
                            <div class="faq-list__faq-answer">faq_answer_2</div>
                        </div>
                        <div class="faq-list__faq">
                    ...
                    <div class="faq__more">
                        <a href="{!! route('site.show_page', ['languageUrl' => \Str::lower($language->shortname), 'pageUrl' => 'e-commerce' ]) !!}" class="primary-button">@d('faq_detail')</a>
                    </div>
                </div>
            </div>
        </div>
