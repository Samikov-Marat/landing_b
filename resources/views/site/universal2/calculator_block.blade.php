                            ...
                            <div class="form-field">
                                <div class="form-field form-order-customer-type-wrapper">
                                    <div class="choice-widget">
                                        <input type="radio" name="customer_type" value="B" id="id_feedback_legal_entity" class="form-field__input"><label for="id_feedback_legal_entity">@d('feedback_form_field_customer_type_legal_entity')</label>
                                    </div>
                                </div>
                                <div class="form-order-customer-type-wrapper">
                                    <div class="choice-widget">
                                        <input type="radio" name="customer_type" value="C" id="id_feedback_private_individual" class="form-field__input"><label for="id_feedback_private_individual">@d('feedback_form_field_customer_type_private_individual')</label>
                                    </div>
                                </div>
